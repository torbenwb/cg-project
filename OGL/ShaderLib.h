...
namespace OGL
{
    ...
    {
    public:
        static GLuint bufferTextureFromFile(const char* filename, bool pixelTexture = false){
        ...
        static GLuint bufferTextureFromData(unsigned char* data, int width, int height)
        {
            GLuint textureID;
            glGenTextures(1, &textureID);
            glBindTexture(GL_TEXTURE_2D, textureID);
        ...
        static GLuint generateCheckerboardTexture(int width, int height) {
            GLuint textureID;
            glGenTextures(1, &textureID);
            glBindTexture(GL_TEXTURE_2D, textureID);
        ...
        static GLuint compileShader(const char **code, GLint type)
        {
        ...
        static GLuint compileShader(const char* filePath, GLint type)
        {
